...
pretrained = 'work_dirs/pretrains/mask_rcnn_swin_tiny_patch4_window7_backbone.pth'  # noqa
...
data = dict(
    ...
    val=dict(
        ...
        img_prefix=data_root + "Data/VID",
        ref_img_sampler=dict(
            num_ref_imgs=28, frame_range=[-7, 7], method="test_with_adaptive_stride"
        ),
...
# runtime settings
total_epochs = 9
evaluation = dict(metric=["bbox"], interval=9)
